...
**0020** (`embedding_provenance`). `main` already carries 0016 and 0017 and the durability
branch is taking 0018/0019, so this comes up from 0020 — checked against `main` rather than
counted, because two branches had already collided on a number today. Nothing in 0020 touches
...
**Vad Photographic sparar om det.** Migration 0020 lägger `embedding_model`,
